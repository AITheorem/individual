...
from tr.result_files.patch_and_stats import single_path_patch_search
...
for line_idx, line_label in enumerate(line_labels):
    for checkpoint_filename in all_paths[line_idx]:
        ...
        current_results = {}
        single_path_patch_search(current_results, model, test_set)
...
plt.tight_layout()
# plt.savefig("charts/varyL_s2nm_maxsearch.png")
plt.show()
